...
namespace QLCore
{
   ...
   public class PiecewiseZeroInflationCurve : ZeroInflationTermStructure, Curve<ZeroInflationTermStructure>
   {
      ...
      public double guess<C>(int i, C c, bool validData, int first) where C : Curve<ZeroInflationTermStructure> { return traits_.guess(i, c, validData, first); }
      public double minValueAfter<C>(int i, C c, bool validData, int first) where C : Curve<ZeroInflationTermStructure> { return traits_.minValueAfter(i, c, validData, first); }
      public double maxValueAfter<C>(int i, C c, bool validData, int first) where C : Curve<ZeroInflationTermStructure> { return traits_.maxValueAfter(i, c, validData, first); }
